...
class DataIO(object):
    ...
    def save_data(self, file_name, data_dict_to_save):
        ...
        with zipfile.ZipFile(os.path.join(self.folder_path, file_name), 'w', compression=zipfile.ZIP_DEFLATED) as myzip:
    ...
    def load_data(self, file_name):
        ...
        dataFile = zipfile.ZipFile(os.path.join(self.folder_path, file_name))
